...
const projects = [
  {
    ...
    desc: 'An interactive word-based board game inspired by Snakes & Ladders. Players climb the board by solving word challenges, built with real-time game state management and a responsive UI.',
  ...
  },
  {
    ...
    tech: ['Next.js', 'React', 'Tailwind', 'PostgreSQL', 'Prisma'],
